...
@TargetApi(Build.VERSION_CODES.HONEYCOMB) public class CircularProgressDrawable extends Drawable
  ...
  @TargetApi(Build.VERSION_CODES.HONEYCOMB) private void setupAnimations() {
  ...
  @TargetApi(Build.VERSION_CODES.HONEYCOMB) private void stopAnimators() {
